...
(default,'La Cabeza de Macri',4000,'','','Este es un libro ... que tiene ... muy interesante...','','/img/products/book-la-cabeza-de-macri.webp',9,1,2,1,null),
(default,'Matar un Ruiseñor',3260,'','','','','/img/products/book-matar-a-un-ruisenior.webp',9,2,1,1,null),
(default,'Red Queen',2600,'','','','','/img/products/book-harry-potter.jpeg',9,4,1,1,null),
(default,'Harry Potter',5200,'','','','','/img/products/book-red-queen.webp',9,3,1,1,null),
(default,'Las Vidas dentro De tu cabeza',5400,'','','','','/img/products/book-las-vidas-dentro-de-tu-cabeza.webp',9,1,1,1,null),
(default,'El Buen Cirujano',5400,'','','','','/img/products/book-el-buen-cirujano.webp',9,5,1,1,null),
